package org.metacubic.metacore.web.rest;
...
import org.metacubic.metacore.IntegrationTest;
import org.metacubic.metacore.config.EmbeddedKafka;
import org.metacubic.metacore.config.KafkaSseConsumer;
import org.metacubic.metacore.config.KafkaSseProducer;
...
class MetacoreKafkaResourceIT {
    ...
    void producesMessages() throws InterruptedException {
        client.post().uri("/api/metacore-kafka/publish?message=value-produce").exchange().expectStatus().isNoContent();
    ...
    void consumesMessages() {
        ...
        String value = client
            .get()
            .uri("/api/metacore-kafka/consume")
