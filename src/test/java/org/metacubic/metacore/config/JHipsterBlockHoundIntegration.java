package org.metacubic.metacore.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("org.metacubic.metacore.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("org.metacubic.metacore.security.DomainUserDetailsService", "createSpringSecurityUser");
