...
@RestController
@RequestMapping("/api/metacore-kafka")
public class MetacoreKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MetacoreKafkaResource.class);

    private final MessageChannel output;
    private Sinks.Many<Message<String>> sink = Sinks.many().unicast().onBackpressureBuffer();

    public MetacoreKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
